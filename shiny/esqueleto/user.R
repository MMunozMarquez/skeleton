...
information.text <- function(language = 'en') {
    switch(language,
           es = HTML('<p align="justify">Aplicación que permite la creación, edición, carga y descarga de un fichero csv con datos. \
                   ...
                   <p align="justify">Realizado con shiny por <a href="mailto:manuel.munoz(at)uca.es">M. Muñoz-Márquez</a> bajo licencia GNU-GPL como parte del <a href="http://knuth.uca.es/R">Proyecto R-UCA</a>.</p>\
                   <p align="justify">Más información disponible en la página <a href="https://skeleton.proyectos.de/indice.html">Proyecto esqueleto</a>.</p>\
                   <p align="justify">Fuentes disponibles en <a href="https://github.com/MMunozMarquez/skeleton/" target=_blank>GitHub</a></p>.<hr>\
           ...
           HTML('<p align="justify">This application allows create, edit, load and download a csv data file. \
                   ...
                   <p align="justify">Developed using shiny by <a href="mailto:manuel.munoz(at)uca.es">M. Muñoz-Márquez</a> under GNU-GPL licence inside <a href="http://knuth.uca.es/R">R-UCA Project</a>.\
                   <p align="justify">More information available at web page <a href="https://skeleton.proyectos.de/index.html">Skeleton Project</a>.\
                   <p align="justify">Source code available at <a href="https://github.com/MMunozMarquez/skeleton/" target=_blank>GitHub</a></p><hr>\
